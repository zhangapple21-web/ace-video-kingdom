...
("F02","office_keyboard.png","阿浪穿浅灰旧短袖衬衫同时操作多个聊天窗口，手指快速复制粘贴，手机不断震动，镜头横移跟随，动作持续。"),
...
for sid,anchor,prompt in shots:
 cmd=[sys.executable,str(root/"tools/run_short_clip.py"),"--shot-id",sid,"--prompt",prompt,"--manifest",str(manifest),"--output",str(out/f"{sid}.mp4"),"--model","agnes-video-v2.0","--image",str(anchors/anchor),"--width","704","--height","1280","--num-frames","241","--frame-rate","24","--timeout","900"]
